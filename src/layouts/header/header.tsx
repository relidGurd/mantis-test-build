...
const Header = ({ menu_list }: any) => {
  ...
  const subMenuRefDesktop = useRef<HTMLUListElement>(null);

  useEffect(() => {
    const handleClick = (e: any) => {
      if (
        subMenuRefDesktop &&
        subMenuRefDesktop.current &&
        !subMenuRefDesktop.current.contains(e.target as Node)
      ) {
  ...
  }, [subMenuRefDesktop, isDropdownOpen]);
              ...
              <ul className={styles.mainLinks}>
                <li className={styles.header_linkItem}>
                  ...
                  >
                    ...
                    <div
                      className={classNames(
                        isDropdownOpen ? styles.arrowOn : styles.arrowOff,
                        styles.arr
                      )}
                    >
                      <Arrow
                        ...
                        color={classNames(
                          !isDropdownOpen ? "white" : "var(--main-green)"
                        )}
                      />
                    </div>
                  </button>
